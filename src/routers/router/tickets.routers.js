...
export default class ProductsRouter extends CustomRouter {
    init() {
        ...
        //Endpoint POST para crear un nuevo ticket. http://localhost:8080/api/tickets
        this.create("/", passportMW("current"), TicketApiController.POSTCreateTicket)

        //Endpoint GET para calcular el total a pagar. http://localhost:8080/api/tickets
