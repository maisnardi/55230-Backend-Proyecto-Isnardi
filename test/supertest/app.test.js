    ...
    function () {
        ...
        it("testing that a user registers to the application",
            async () => {
                ...
                let response = await requester.post("/register").send(userData)
            ...
            it("testing a user logs in to the application",
                async () => {
                    ...
                    let response = await requester.post('/login').send(userLogin)
        ...
        it("testing change of user rol",
            async () => {
                ...
                let response = await requester.put('/users/premium/' + userId).send(newRole);
        ...
        it("testing that a user can read the system products",
            async () => {
        ...
        it("testing that a user can update a system product",
            async () => {
